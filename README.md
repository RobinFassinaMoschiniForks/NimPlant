...
- _Furkan Göksel ([@frkngksl](https://github.com/frkngksl)) and Guillaume Caillé ([@OffenseTeacher](https://github.com/offenseteacher)) for their work on NiCOFF and implementing `inline-execute`_
